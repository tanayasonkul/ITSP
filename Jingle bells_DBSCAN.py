...
samplingFrequency, signalData = wavfile.read(r'C:\Users\tason\OneDrive\Desktop\ITSP\Violin_Jingle bells.wav')
...
plot.specgram(signalData[:,0],NFFT=nfft,noverlap=noverlap,Fs=samplingFrequency)#,cmap='jet')
plot.ylim([lowFreq,maxFreq])
